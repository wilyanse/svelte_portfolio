...
<Wrapper id="Contact">
    <div class="flex flex-col gap-5">
        ...
        <div class="logo-cloud grid-cols-1 lg:!grid-cols-3 gap-1">
            <a href="https://www.linkedin.com/in/wilyanse/">
                <span>
            ...
            <a href="https://join.skype.com/invite/tHKbT7LoOati">
                <span>
...
<style lang="postcss">
    h1 {
        @apply font-bold text-5xl h1 uppercase;
    }
